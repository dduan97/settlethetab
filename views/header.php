...
<head>
  ...
  <link rel="shortcut icon" href="images/SettletheTabIcon1.png">
  ...
  <div id="header">
    <a href="/dashboard.php"><img src="/images/SettletheTabLogo1.png"></a>
    <a href="/logout.php" id="tab"><img class="tab" src="/images/tab1.png"></a>
